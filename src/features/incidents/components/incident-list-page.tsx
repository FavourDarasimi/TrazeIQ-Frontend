          ...
          {incidents.map((incident) => (
            <li key={incident.id}>
              <Link
                ...
                className="flex flex-col gap-2 rounded-md px-2 py-3.5 transition-colors duration-150 hover:bg-bg-panel focus-visible:bg-bg-panel focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent sm:flex-row sm:items-center sm:justify-between sm:gap-6"
              >
